...
import { PointerSystem, Naub, Pointer, Naubino } from '../src/naubino';
import { Vector, Matter } from '../src/matter-js';
    ...
    describe('Pointer', function() {
        ...
        describe('moveTo', function() {
            ...
            it('moves naub in 1 sec 600 px', function() {
                ...
                const check = () =>
                    assert.isBelow(Vector.distance(naub_a.pos, pos_b), naub_a.radius, 'naub near destination');
